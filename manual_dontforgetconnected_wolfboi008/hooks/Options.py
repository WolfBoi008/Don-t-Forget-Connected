...
def after_options_defined(options: Type[PerGameCommonOptions]):
    ...
    options.type_hints["spiders"].visibility = Visibility.none
    options.type_hints["grillby"].visibility = Visibility.none
    options.type_hints["tem"].visibility = Visibility.none
    options.type_hints["diner"].visibility = Visibility.none
    options.type_hints["darkners"].visibility = Visibility.none
    pass
